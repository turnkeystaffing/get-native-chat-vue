...
native-chat-vue is a lightweight, embeddable AI chat widget built as a Vue 3 plugin. It provides a complete chat interface — floating action button, slide-out panel, message list with infinite scroll, markdown rendering, and error recovery — that integrates into any Vue 3 + Vuetify 3 application with minimal configuration.
...
| Testing | Vitest 4 (210+ unit/integration tests) + Playwright (perf benchmarks) |
| Docs | VitePress ^1.6 |
...
├── src/                   Library source (8 components, 5 icons, 1 composable, 1 helper, types)
├── dist/                  Build output (ES module + CSS + .d.ts)
├── docs/                  VitePress documentation + project knowledge
...
- [Architecture](./architecture.md) — Full architecture, patterns, component hierarchy, public API
- [Source Tree Analysis](./source-tree-analysis.md) — Annotated directory tree, data flow diagrams
- [Component Inventory](./component-inventory.md) — All components with props, events, and behaviors
